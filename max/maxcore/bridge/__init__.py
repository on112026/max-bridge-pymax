...
пакета), чтобы работал импорт ``from maxcore.bridge import register_bridge``
из ``max/maxcore/supervisor/client_runtime.py`` — Python при этом импортирует
...
from maxcore.bridge.chats import chat_to_dict, display_name_of
from maxcore.bridge.media import process_file, process_photo, process_video
from maxcore.bridge.on_start import on_start_actions
from maxcore.bridge.users import user_display_name
from maxcore.pymax_patches import apply as apply_pymax_patches
