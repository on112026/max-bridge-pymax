...
(в ``__init__.py`` пакета), чтобы работал импорт ``from maxcore.supervisor
...
from maxcore import chat_ops
from maxcore import reactions_loop as reactions
from maxcore.sender import sender_loop
from maxcore.supervisor._backoff import (
    AUTH_FAIL_BACKOFF,
    NORMAL_POLL_SECONDS,
    RATE_LIMIT_BACKOFF,
    SMS_RESEND_COOLDOWN,
...
from maxcore.supervisor.cache import (
    find_session_files,
    watch_session_file,
    wipe_cache,
)
from maxcore.supervisor.client_runtime import _long_running_start, build_client
from maxcore.supervisor.read_receipts import read_receipts_loop
from maxcore.supervisor.twofa_drain import drain_2fa_codes_loop
